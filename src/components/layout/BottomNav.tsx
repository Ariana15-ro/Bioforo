        ...
        if (center) {
          return (
            <NavLink
              ...
              aria-label={label}
            >
              <span className="grid h-14 w-14 place-items-center rounded-full bg-bio-500 text-white shadow-lg shadow-bio-500/40 ring-4 ring-white">
                <Icon size={28} />
              </span>
            </NavLink>
          );
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                ...
                isActive ? "text-bio-500" : "text-slate-500 hover:text-slate-700",
              )
            }
          >
